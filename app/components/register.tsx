      ...
      <div className="py-4 max-w-md w-full">
        <div className="p-6 rounded-lg bg-white border border-slate-300 shadow-xs md:p-8 dark:bg-neutral-800 dark:border-neutral-700">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 mt-10">
            ...
            <label className="flex items-start group has-[input:checked]:text-slate-900">
              <input
                id="terms"
                name="terms"
                type="checkbox"
              ...
              {/* Custom box */}
              <span
                className="mt-0.5 flex h-4 w-4 shrink-0 items-center justify-center rounded outline-1 outline-slate-300 dark:outline-neutral-600
              ...
              <span className="ml-3 text-sm text-slate-700 dark:text-slate-300">
                ...
                <a
                  href="#"
                  className="text-blue-700 hover:underline font-medium dark:text-blue-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded"
                >
                  Terms & Conditions
                </a>
              </span>
